                            ...
                            <div class="_prt_filt_dash">
                                ...
                                <div class="_prt_filt_dash_last m2_hide">
                                    ...
                                    <!-- <div class="_prt_filt_add_new">
                                        <a href="#" class="prt_submit_link"><i class="fas fa-plus-circle"></i><span class="d-none d-lg-block d-md-block">Tạo tại khoản mới</span></a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th scope="col" class="m2_hide">Hoạt động gần đây</th>
                                                <th scope="col" class="m2_hide">Vai trò</th>
                                                <th scope="col" class="m2_hide">Cập nhật gần đây</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="m2_hide">
                                                        ...
                                                        <div class="_leads_view">
                                                            <h5 class="up"><?php echo $account_type_name; ?></h5>
                                                        </div>
                                                        <!-- <div class="_leads_view_title"><span>Worlicity</span></div> -->
                                                    </td>
                                                    <td class="m2_hide">
                                                        <div class="_leads_posted">
                                                            <h5><?php echo date('d M - H:i', strtotime($user['updated_at'])); ?></h5>
                                                        </div>
